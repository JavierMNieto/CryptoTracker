...
urlpatterns = [
    ...
    path('<uuid:session_id>/group/c', views.custom_group, name='group'),
    path('<uuid:session_id>/getTxs', views.get_txs, name='get_txs'),
    path('<uuid:session_id>/getGraph', views.get_graph_data, name='getGraph'),
    ...
    path('isValidAddr', views.is_valid_addr),
